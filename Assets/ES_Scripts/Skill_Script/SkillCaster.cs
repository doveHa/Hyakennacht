...
public class SkillCaster : MonoBehaviour
{
    ...
    {
        yield return null; // �� ������ ��� ��, Witch/Body�� ������ �� �ٽ� ���ε�
        EnsureActorRefs(force: true);
        EnsureFacingProxy();
    }
    ...
    void EnsureActorRefs(bool force = false)
    {
        ...
        {
            actor = FindDeepChildByName(gmPlayer, "Body") ?? gmPlayer;  // ���� �� Player�� ����
        }
    ...
    public float GetGCDTotal() => gcd;           // �� GCD ����
    public SkillBase[] GetSlots() => slots;      // UI���� ���� �迭 ���ٿ�
    ...
    /*    public void RegisterSkill(int slotIndex, SkillBase skillName)
        {
            ...
            if (newSkill == null)
            {
                Debug.LogWarning($"��ų '{skillName}'�� Resources �������� ã�� �� �����ϴ�.");
                return;
            }
            ...
            Debug.Log($"���� {slotIndex}���� ��ų {newSkill.name} ���");
        }*/
    ...
    /*    public void RegisterSkill(int slotIndex, SkillBase skill)
        {
            ...
            if (skill == null)
            {
                Debug.LogWarning("RegisterSkill ȣ�� �� SkillBase�� null�Դϴ�.");
                return;
            }

            slots[slotIndex] = skill;
            Debug.Log($"���� {slotIndex}���� ��ų {skill.name} ���");
        }*/
    ...
    public void RegisterNextSkill(SkillBase skill)
    {
        ...
        if (skill == null)
        {
            Debug.LogWarning("RegisterNextSkill ȣ�� �� SkillBase�� null�Դϴ�.");
            return;
        }
